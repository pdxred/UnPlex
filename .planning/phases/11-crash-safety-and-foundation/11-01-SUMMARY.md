...
plan: 01
subsystem: ui
tags: [brightscript, scenegraph, roku, loading-spinner, busy-spinner, sigsegv, crash-fix]
...
affects:
  - 11-crash-safety-and-foundation (all subsequent plans)
  - 12-tv-show-navigation-enhancements
  - All future screen work

# Tech tracking
tech-stack:
  added: []
  patterns:
    - "Safe loading indicator: Label+Rectangle overlay with Timer-based 300ms delay threshold instead of BusySpinner"
    - "NEVER instantiate BusySpinner on Roku — causes firmware SIGSEGV ~3s after init"
